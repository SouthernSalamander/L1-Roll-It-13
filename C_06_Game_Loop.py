...
while cpu_score < game_goal and user_score < game_goal:

    # Start of round loop
    # For testing purposes, ask the user what the points for the user / computer were
    cpu_points = int(input("Enter the computer points at the end of the round"))
    ...
    print(f"User Score: {user_score} | Computer Score: {cpu_score}")
